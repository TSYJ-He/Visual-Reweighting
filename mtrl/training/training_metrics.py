...
def aggregate_metrics(metrics: dict[str, list[Any]]) -> dict[str, Any]:
    """Aggregate metrics by computing mean values."""
    return {key: np.mean(value) for key, value in metrics.items()}


def calculate_sequence_length_metrics(batch: DataProto) -> dict[str, Any]:
    """Calculate metrics related to sequence lengths."""
...
def calculate_batch_statistics(batch: DataProto, use_critic: bool = False) -> dict[str, Any]:
    """Calculate statistics for the training batch."""
    ...
    return {
        ...
        **calculate_sequence_length_metrics(batch),
    }


def calculate_timing_statistics(batch: DataProto, timing_raw: dict[str, float]) -> dict[str, Any]:
    """Calculate timing statistics for different training phases."""
...
def calculate_throughput_statistics(batch: DataProto, timing_raw: dict[str, float], num_gpus: int) -> dict[str, Any]:
